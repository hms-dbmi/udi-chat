...
| ----------------------------- | ------------------------------------------------------------------------------ | ----------------------------------------------- |
| `VITE_LLM_API_BASE_URL`       | Base URL for the LLM API (can include port, e.g. `http://localhost:8007`).     | `http://localhost`                              |
| `VITE_LLM_API_PORT`           | Optional port override. If set, appended to `VITE_LLM_API_BASE_URL`.          | (none)                                          |
...
VITE_LLM_API_BASE_URL=http://localhost:8080
