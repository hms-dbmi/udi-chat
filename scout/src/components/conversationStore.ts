...
export const useConversationStore = defineStore('conversationStore', () => {
  ...
  const messages = ref<Message[]>([
    {
      role: 'system',
      content: `Always answer with a vega-lite spec. Only include the json file, do not include any other text. Always point to this tabular dataset "./data/hubmap-datasets-metadata-2024-11-15_20-36-10.tsv". This dataset has the following column names.
