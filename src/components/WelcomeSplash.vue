...
<template>
  <div class="splash-container">
    ...
    <!-- Hand-drawn arrow pointing left, responsive width -->
    <svg class="splash-arrow" viewBox="0 0 200 60" fill="none" preserveAspectRatio="xMinYMid meet">
      <path
